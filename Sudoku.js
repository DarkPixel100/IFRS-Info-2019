...
switch (aux)
{
    case 0:
    {
       ...
       sc = prompt("Deseja substituir algum número do tabuleiro antes de finalizar o jogo?(Você poderá substituir 3 números; caso queira, digite \"sim\", caso não queira ou precise substiruir mais números do que isso, digite \"não\")");
       
       if(sc == "Sim" || sc == "sim")
       {
       coord = prompt("Primeira substituiçáo de jogada. Digite a coordenada(A1, A2, ... B1, B2, ...) que representa a posição na qual o número que será digitado estará(caso não queira substituir nada, deixe em branco):\n"+jogo);
       ...
       coord = prompt("Segunda substituiçáo de jogada. Digite a coordenada(A1, A2, ... B1, B2, ...) que representa a posição na qual o número que será digitado estará(caso não queira substituir nada, deixe em branco):\n"+jogo);
       ...
       coord = prompt("Terceira substituiçáo de jogada. Digite a coordenada(A1, A2, ... B1, B2, ...) que representa a posição na qual o número que será digitado estará(caso não queira substituir nada, deixe em branco):\n"+jogo);
       ...
       if(coord == 'D4' || coord == 'd4')
       {
            ...
            alert("Ok, agora o tabuleiro será corrigido.")
     }
     else if (sc == "Não" || sc == "não" || sc == "Nao" || sc == "nao")
     {
          alert("Ok, agora o tabuleiro será corrigido.")
     }
       /*  1   2   3   4
